  ...
  const trade = [
    {
      ...
      title: "We offer a robust and user-friendly trading platform with advanced technology and real-time data for our clients."
    },
    {
      image: Research,
      heading: "Research and Analysis",
      title: "We provide comprehensive market research, analysis, and investment recommendations to help clients make informed trading decisions."
    },
    {
      image: acess,
      heading: "Market Access",
      title: "We ensure reliable and secure access to the stock market, with redundancy and failover systems to minimize downtime."
    },
    {
      image: train,
      heading: "Education and Training",
      title: "Our focus is on educating clients and offering trading courses, webinars, and resources to help clients become more knowledgeable."
    },
    {
      image: day,
      heading: "Day Trading",
      title: "Our focus is on short-term trading strategies, often buying and selling securities within the same trading day."
    },
    {
      image: low,
      heading: "Low-Cost Trading",
      title: "Competing on the cost by offering low commissions, minimal fees, and cost-effective trading solutions for clients."
    }
  ]
    ...
    <>
            ...
            <div className="col-lg-6 mt-5">
              ...
              <div className="trade-wrape-div">
                ...
                <p className="trade-para">
                  ...
                  will help you invest money, manage, and grow your money!                </p>
              </div>
          ...
          <div className="row flex justify-center items-center pt-1">
            <div className="col-lg-6 col-md-6 col-sm-12 home-content-wrapper">
              ...
              <p className="main__common__para text-black pt-3">
                Intraday trades, also known as day trading, involve buying and selling a stock within a trading session,
                i.e. on the same day. If you do not square off your situation by the end of the day, your stock can be sold automatically at the day’s closing price under assured brokerage plans. Maximum traders set up an intraday trade by setting a target price for a stock and buying it if it is trading under the target price.
              </p>
              ...
              <Collapse isOpened={isopen}>
                <p className="main__common__para text-black pt-3">
                  ...
                  The idea behind trading shares intraday is to make quick profits within a day.
                </p>
              </Collapse>

              <button className="main-btn" onClick={() => setisopen(!isopen)}>Read more</button>
            </div>

            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="main__image__common" data-aos="fade-left">
                <img src={Intraday_trading1} alt="" className="img-fluid rounded-md" ></img>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="about-home" class="about-home">
        <div class="section-header text-center">
          <h2 className="text-center capitalize  text-[28px] font-medium font-jost leading-[48px] md:text-[38px] md:leading-[55px]" style={{ paddingTop: "46px", color: "#059473", fontWeight: "500" }}>About Us</h2>
        ...
        <div class="container aos-init aos-animate"
          ...
          <div class="row align-items-xl-center gy-5">
            ...
            <div class="col-xl-5 content">
              <h2 className="mb-3 text-[#059473]  ">Know About Sky Commodity</h2>

              <p>Sky Commodity was started in 2007, Sky Commodity now has a presence in over 50+ locations with 13+ years 3.5+ Lakhs happy customers, and 7.5+ lakh follow-up customers nationwide. Sky Commodity earned the trust of these valued investors by providing them with top-notch services in various trading and investment.</p>
            </div>
              ...
              <div class="row gy-4 icon-boxes">
                ...
                <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                  <div class="icon-box">
                    {/* <AiFillInstagram /> */}
                    <img src={quality}
                      className="w-16 h-16 mb-2" alt="log" />
                    <h3>QUALITY</h3>
                    <p>Our <strong className="font-semibold">QUALITY</strong> of services will be the best in India. We will provide excellence, and respond vigorously to change. We are responsible for the quality of whatever we provide.
                ...
                <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box">
                    <img src={cliet}
                      className="w-12 h-12  mb-2" alt="log" />
                    <h3>CLIENT</h3>
                    <p>We value our <strong className="font-semibold">CLIENT</strong>  always. We treat one another with respect and take pride in the significance. We are committed to openness and trust in all relationships.
                ...
                <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                  <div class="icon-box">
                    <img src={custum}
                      className="w-12 h-12  mb-2" alt="log" />
                    <h3>CUSTOMER</h3>
                    <p>We deliver <strong className="font-semibold">CUSTOMER</strong>  satisfaction. We are dedicated to satisfying our customers. We strive to exceed their expectations in affordability, quality and on-time delivery.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
                  <div class="icon-box">
                    <img src={interg}
                      className="w-12 h-12 mb-2 object-cover" alt="log" />
                    <h3 className="">INTEGRITY</h3>
                    <p>We act with <strong className="font-semibold">INTEGRITY</strong>  in all we do. We fulfill our responsibility & commitments to our clients. We will consistently treat customers and company resources with the respect they deserve.
                    </p>
                  </div>
                </div>
      ...
      <section className="slider__section__main bg-[#1EB2A6]">
        <div className="container">
          <div className="row flex justify-center items-center text-center ">
            <h3 className="text-white text-center capitalize text-[28px] font-medium font-jost  leading-[48px] md:text-[38px] md:leading-[55px]">We are Trusted</h3>
            <div className="col flex justify-center items-center text-center flex-row gap-1">
              <div className="color1"></div> <div className="color2"></div>{" "}
              <div className="color3"></div> <div className="color4"></div>{" "}
              <div className="color5"></div> <div className="color6"></div>
              ...
              trade.map((spece) => {
                return (
                  <div className="  border-b-[10px] border-b-[#ff5e14] rounded-lg  h-auto md:h-[410px] bg-white overflow-hidden">
                    <div className="">
                      <img className=" w-full h-32   lg:h-48   object-cover rounded-t-lg" src={spece.image} alt={spece.image} />
                    </div>
                    <div className="inner__worldClass__content">
                      <h3 className="inner__wordclass__heading">{spece.heading}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-gap-4 pt-4 trusted-platform">
            <div className="col">
              ...
              <div className="mobile-image">
                <img src={mobileIcon} alt="mobile" className="w-full moving-rotating-image   md:h-[560px]" />
              </div>
            </div>
            <div className="col">
              <div className="mobile__content features-future">
                ...
                <h2 className="text-[20px] text-[#1EB2A6] uppercase pt-3 pb-1">
                  Do your investment needs Directly through </h2>
                <h1 className=" text-2xl md:text-3xl lg:text-4xl font-bold font-popin">The Mobile Apps</h1>
                <div className="col flex justify-start items-center text-center flex-row gap-1 mb-5">
                  <div className="color1"></div> <div className="color2"></div>{" "}
                  <div className="color3"></div> <div className="color4"></div>{" "}
                  <div className="color5"></div> <div className="color6"></div>
                </div>
                <div class="icon-box shadow-md mt-4 mt-lg-0 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="150">
                  {/* <i class="bx bx-receipt"></i><BsFillCalendar2EventFill /> */}

                  <div className="flex ">
                    <img src={stock1} className=" w-10 h-10 rounded-lg" alt="trade" />
                    <div style={{ padding: "0px !important" }}>
                      <h4 className="font-bold">Intraday Trading</h4>
                      <p>
                        Now you can buy and sell multiple shares in intraday by our mobile  app.
                      </p>
                    </div>
                  </div>

                </div>
                <div class="icon-box shadow-md  mt-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="150">
                  <div className="flex ">
                    <img src={stock2} className=" w-10 h-10 rounded-lg" alt="trade" />
                    <div style={{ padding: "0px !important" }}>
                      <h4>Stock Holdings</h4>
                      <p>
                        Now you can buy and sell multiple shares in holdings by our mobile  app.</p>
                    </div>
                  </div>
                </div>
                <div class="icon-box shadow-md  mt-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="150">
                  <div className="flex ">
                    <img src={stock3} className=" w-10 h-10 rounded-lg" alt="trade" />
                    <div style={{ padding: "0px !important" }}>
                      <h4>Common Stock</h4>
                      <p>
                        Now you can buy and sell multiple shares in common stock by our mobile  app.</p>
                    </div>
                  </div>
                ...
                <div class="icon-box shadow-md   mt-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="150">
                  <div className="flex ">
                    <img src={stock4} className=" w-10 h-10 rounded-lg" alt="trade" />
                    <div style={{ padding: "0px !important" }}>
                      <h4>Preferred Stock</h4>
                      <p>
                        Now you can buy and sell multiple shares in preferred stock by our mobile  app.</p>
                    </div>
                  </div>

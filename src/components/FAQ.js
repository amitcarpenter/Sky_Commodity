    ...
    <>
      ...
      <section className='py-[50px] sm:py-[62px]'>
        <div className='mx-auto sm:px-0 px-5'>
          <h2 className='text-[28px] sm:text-[32px] font-bold text-center font-spectral sm:px-0 sm:mb-16'>
            Frequently Asked Questions
          </h2>
          <div className='grid grid-col-1 sm:grid-cols-[auto_70%] gap-3'>
            {/* Question List for Large Devices */}
            <div className='hidden sm:block bg-[#059473] h-fit'>
              <ul className='text-white p-0'>
                {questions.map((q, index) => (
                  <li
                    ...
                    className={`${
                      selectedQuestion === index ? 'bg-[#ff5e14] text-white' : ''
